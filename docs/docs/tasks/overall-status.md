...
| **Task 4** | [Non-MPI Scaling](task-04-scaling-laws.md) | **Musfir & Sadia Saeed** | Almost Done | Task distributor: repo setup, worker deployment, scalability law benchmarks. Results on SSD. |
