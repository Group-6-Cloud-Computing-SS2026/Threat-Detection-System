...
export function buildImageUrl(previewUrl: string | null | undefined, apiBaseUrl: string): string | null {
...
export async function apiFetch(apiBaseUrl: string, token: string | undefined, path: string, options?: RequestInit) {
