        ...
        <div className="pb-12 md:pb-20">
          ...
          <Spotlight className="group mx-auto grid max-w-sm items-start gap-6 lg:max-w-none lg:grid-cols-3">
            {steps.map((step, index) => (
              <div
                key={step.label}
                className={`group/card bg-brand-carbon-black-800 relative h-full overflow-hidden rounded-2xl p-px before:pointer-events-none before:absolute before:-top-40 before:-left-40 before:z-10 before:h-80 before:w-80 before:translate-x-[var(--mouse-x)] before:translate-y-[var(--mouse-y)] before:rounded-full before:opacity-0 before:blur-3xl before:transition-opacity before:duration-500 group-hover:before:opacity-100 after:pointer-events-none after:absolute after:-top-48 after:-left-48 after:z-30 after:h-64 after:w-64 after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)] after:rounded-full after:opacity-0 after:blur-3xl after:transition-opacity after:duration-500 hover:after:opacity-20 ${ACCENT_CLASSES[step.accent].glow}`}
              >
                <div className="bg-brand-pitch-black-500 after:from-brand-carbon-black-900/50 after:via-brand-carbon-black-800/25 after:to-brand-carbon-black-900/50 relative z-20 h-full overflow-hidden rounded-[inherit] after:absolute after:inset-0 after:bg-linear-to-br">
                  {/* Step number */}
                  <div
                    className="border-brand-carbon-black-700/50 bg-brand-carbon-black-800/65 text-brand-alabaster-grey-200 absolute top-6 right-6 flex h-8 w-8 items-center justify-center rounded-full border text-sm font-medium"
                    aria-hidden="true"
                  >
                    {index + 1}
                  </div>
                  ...
                  <div className="p-6">
                    <div className="mb-3">
                      <span className="btn-sm bg-brand-carbon-black-800/40 before:[background:linear-gradient(to_bottom,--theme(--color-brand-carbon-black-700/.15),--theme(--color-brand-carbon-black-700/.5))_border-box] hover:bg-brand-carbon-black-800/60 relative rounded-full px-2.5 py-0.5 text-xs font-normal before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)]">
