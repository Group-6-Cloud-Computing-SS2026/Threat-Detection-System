  ...
  return (
    <section className="relative">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-brand-carbon-black-700/.5),transparent)1] md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-brand-alabaster-grey-600/80">
              ThreatOff combines computer vision, edge inference, and
              container orchestration to detect people and flag threats
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              <svg
                className="mb-3 fill-brand-light-green-500"
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-brand-alabaster-grey-100">
                Multi-Node Sensor Network
              </h3>
              <p className="text-brand-alabaster-grey-600/80">
                Deploy one or many Raspberry Pi sensor nodes and monitor them
                as a single, coordinated infrastructure.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-brand-alabaster-grey-600/80">
                Detection runs directly on-device, so recognizing a threat
                never depends on a round trip to the cloud.
              </p>
            </article>
            <article>
              <svg
                className="mb-3 fill-brand-brick-red-500"
                xmlns="http://www.w3.org/2000/svg"
                width={24}
                height={24}
              >
              ...
              <p className="text-brand-alabaster-grey-600/80">
                On-device YOLO models locate and track people in the frame in
            ...
            <article>
              ...
              <p className="text-brand-alabaster-grey-600/80">
                Every scenario ships with complete, versioned documentation
                so students and researchers can rebuild the setup themselves.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-brand-alabaster-grey-600/80">
                Confirmed events are published over MQTT and reach the live
            ...
            <article>
              ...
              <p className="text-brand-alabaster-grey-600/80">
                Distinguishes between event types — theft, fire, and
                vandalism — instead of raising a single generic alarm.
              </p>
            </article>
          </div>
        </div>
