...
export const homePanelClass =
  `${homeSurfaceClass} relative overflow-hidden rounded-2xl`;

export const homePanelHoverClass =
  `${homePanelClass} transition-[transform,border-color,box-shadow,background-color] duration-300 ease-out hover:-translate-y-0.5 hover:border-brand-carbon-black-600 hover:shadow-[0_24px_70px_rgba(0,0,0,0.38)]`;
